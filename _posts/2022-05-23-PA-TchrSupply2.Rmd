...
```{r,echo=FALSE,message=FALSE,warning=FALSE}
df$StayMove_or_NA<-factor(df$StayMove_or_NA, levels="Stayed in LEA","Moved LEA","NA: Next Record Diff Tchr",ordered = T)
...
For example, in 2016-17, there were `r df %>% dplyr::filter(year=="16_17") %>% count()` teachers in the analysis file and about `r pct1617` percent "left" teaching in Pennsylvania by 2017-18.
